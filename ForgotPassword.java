...
public class ForgotPassword extends JFrame implements ActionListener{
    ...
    public ForgotPassword() {
        ...
        t3.setColumns(10);
        t3.setBounds(277, 161, 140, 20);
        contentPane.add(t3);

        t4 = new JTextField();
        t4.setFont(new Font("Tahoma", Font.BOLD, 13));
        t4.setForeground(new Color(252, 55, 92));
        t4.setColumns(10);
        ...
        b1.setFont(new Font("Bell MT", Font.BOLD, 12));
        ...
        b2.setFont(new Font("Bell MT", Font.BOLD, 12));
        b2.setBounds(425, 188, 88, 29);
