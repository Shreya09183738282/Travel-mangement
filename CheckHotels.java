...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public CheckHotels() {
        ...
        Image i14 = i13.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
        ...
        Image i17 = i16.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
        ...
        Image i20 = i19.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
        ImageIcon i21 = new ImageIcon(i20);
        l8 = new JLabel(i21);
        l8.setBounds(0, 0, 900, 900);
        add(l8);
        l8.setVisible(false);

        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel8.jpg"));
        Image i23 = i22.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
        ImageIcon i24 = new ImageIcon(i23);
        l9 = new JLabel(i24);
        l9.setBounds(0, 0, 900, 900);
        add(l9);
        l9.setVisible(false);

        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel9.jpg"));
        Image i26 = i25.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
        ImageIcon i27 = new ImageIcon(i26);
        l10 = new JLabel(i27);
        l10.setBounds(0, 0, 900, 900);
        add(l10);
        l10.setVisible(false);

        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel10.jpg"));
        Image i29 = i28.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
